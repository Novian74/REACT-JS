                ...
                <div className='col-4'>
                    <form onSubmit={handleSubmit(simpan)}>
                        ...
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control" name='keterangan' placeholder="keterangan" {...register("keterangan", { required: true })} />
                        </div>
                        <div className="mb-3">
                            <input type="submit" className="btn btn-primary" name='simpan' />
                        </div>
                    </form>
                </div>
            </div>
                    ...
                    <tbody>
                        {
                            isi.map((val, index) => (
                                <tr key={index}>
                                    ...
                                    <td><button onClick={() => hapus(val.idkategori)} className='btn btn-danger'>Hapus</button></td>
                                    <td><button onClick={() => showData(val.idkategori)} className='btn btn-warning'>Ubah</button></td>
                                </tr>
                            ))
                        }
                    </tbody>
